...
def main(args):
    ...
    if args.dataset_file in ['e2e_mot', 'e2e_dance', 'mot', 'ori_mot', 'e2e_static_mot', 'e2e_joint', 'e2e_hsmot_rgb']:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.dataset_file not in ['e2e_mot', 'e2e_dance', 'mot', 'ori_mot', 'e2e_static_mot', 'e2e_joint', 'e2e_hsmot_rgb']:
