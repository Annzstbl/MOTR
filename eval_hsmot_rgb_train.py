...
class Detector(object):
    def __init__(self, args, model=None, seq_num=2):
        ...
        img_list = os.listdir(os.path.join(self.args.mot_path, 'train/rgb', self.seq_num))

        img_list = [os.path.join(self.args.mot_path, 'train/rgb', self.seq_num, _) for _ in img_list if
        ...
        self.img_height = 900
        self.img_width = 1200
        self.mean = [0.259, 0.274, 0.241]
        self.std = [0.143, 0.140, 0.137]

        self.save_path = os.path.join(self.args.output_dir, 'results_train/{}'.format(seq_num))
        os.makedirs(self.save_path, exist_ok=True)

        self.predict_path = os.path.join(self.args.output_dir, 'preds_train')
...
if __name__ == '__main__':
    ...
    seq_nums = os.listdir(os.path.join(args.mot_path, 'train/rgb'))
    # spec_seq = ['data37-9']
    spec_seq = []
    ...
    for seq_num in seq_nums:
        ...
        det.detect(vis=True, prob_threshold = 0.7)# score低于0.3的删掉
