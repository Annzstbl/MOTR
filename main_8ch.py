...
def get_args_parser():
    ...
    parser.add_argument('--lr_backbone_first_conv', default=[], type=str, nargs='+')
...
def main(args):
    ...
    if args.dataset_file in ['e2e_mot', 'e2e_dance', 'mot', 'ori_mot', 'e2e_static_mot', 'e2e_joint', 'e2e_hsmot_rgb', 'e2e_hsmot_8ch']:
    ...
    param_dicts = [
        ...
        {
            "params": [p for n, p in model_without_ddp.named_parameters() if match_name_keywords(n, args.lr_backbone_names) and p.requires_grad and not match_name_keywords(n, args.lr_backbone_first_conv)],
            "lr": args.lr_backbone,
        },
        {
            "params": [p for n, p in model_without_ddp.named_parameters() if match_name_keywords(n, args.lr_backbone_first_conv) and p.requires_grad],
            "lr": args.lr_backbone * args.lr_backbone_first_conv_multi,
        },
        {
    ...
    param_name_dicts =[
        ...
        {
            "params": [n for n, p in model_without_ddp.named_parameters() if match_name_keywords(n, args.lr_backbone_names) and p.requires_grad and not match_name_keywords(n, args.lr_backbone_first_conv)],
            "lr": args.lr_backbone,
        },
        {
            "params": [n for n, p in model_without_ddp.named_parameters() if match_name_keywords(n, args.lr_backbone_first_conv) and p.requires_grad],
            "lr": args.lr_backbone * args.lr_backbone_first_conv_multi,
        },
        {
            "params": [n for n, p in model_without_ddp.named_parameters() if match_name_keywords(n, args.lr_linear_proj_names) and p.requires_grad],
            "lr": args.lr * args.lr_linear_proj_mult,
        }
    ]
    first_conv_names = []
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.dataset_file not in ['e2e_mot', 'e2e_dance', 'mot', 'ori_mot', 'e2e_static_mot', 'e2e_joint', 'e2e_hsmot_rgb', 'e2e_hsmot_8ch']:
